...
export const BarChartIcon = (p: IconProps) => (
  <svg {...base(p)}>
    ...
    <rect x="12.5" y="8" width="3" height="10" fill="currentColor" stroke="none" />
    <rect x="18" y="5" width="3" height="13" fill="currentColor" stroke="none" />
  </svg>
);
...
export const ChevronSelectIcon = (p: IconProps) => (
  <svg {...base(p)}>
...
export const LoaderIcon = (p: IconProps) => (
  <svg {...base(p)} className={["animate-spin", p.className].filter(Boolean).join(" ")}>
